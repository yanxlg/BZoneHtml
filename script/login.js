...
var _starEffect = __webpack_require__(35);
    ...
    _createClass(Login, null, [{
        ...
        value: function build() {
            if (!navigator.userAgent.match(/(iPhone|iPod|Android|ios|SymbianOS)/i)) {
                _starEffect2.default.instance(); //for PC background
            }
            ...
            $("body").on("click", "#login", function () {
                ...
                if (!userName) {
                    ...
                    if ($("#saveUser")[0].checked) {
                        _user3.default.cacheLogin();
                    } else {
                        _user3.default.removeCache();
                    }
                    (0, _fetch2.default)("/api/LoginApi/Login", {
                        UserName: userName,
                        Password: password
                    }).then(function (res) {
                        if (!res.ok) {
        ...
        value: function getUserInfo() {
            var _user = _user3.default.getInfo();
            if (_user && _user3.default.isCached()) {
